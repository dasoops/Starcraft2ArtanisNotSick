...
enum class Theme(
    ...
    LIGHT(data = "Light", colorScheme = lightScheme),
    LIGHT_DEFAULT(data = "Light.Default", colorScheme = lightColorScheme()),
    DARK(data = "Dark", colorScheme = darkScheme),
    DARK_DEFAULT(data = "Dark.Default", colorScheme = darkColorScheme()),
    ;

    val show: String = data
...
fun MyTheme(
    ...
    MaterialTheme(
        ...
        typography = typography(theme.colorScheme.primary),
        shapes = shapes,
        content = content
    )
}
